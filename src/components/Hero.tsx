      ...
      <div className="mx-auto w-screen max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 md:grid md:grid-cols-2 md:items-center md:gap-4 lg:px-8 lg:py-32">
        ...
        >
          ...
          <p className="mt-4 text-base text-pretty text-gray-700 sm:text-lg/relaxed dark:text-gray-200">
            we provides expert languages translation solutions to connect your
            business with global audience. Our team of skilled linguists and
            advanced technology ensure accurate and culturally relevant
            translations across various industries.
          </p>
