        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gray-200 p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600 text-sm">
              Accurate and culturally relevant translations for all your
              business needs.
            </p>
          </div>
          ...
          <div className="bg-gray-200 p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600 text-sm">
              Professional translations of legal, technical, and business
              documents.
            </p>
          </div>
          ...
          <div className="bg-gray-200 p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-600 text-sm">
              Expert interpretation services for meetings, conferences, and
              events.
            </p>
          </div>
